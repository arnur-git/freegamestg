...
export default function Dashboard() {
  ...
  return <main className="shell">
    <nav className="nav"><Link href="/" className="brand"><span className="brand-mark">FR</span><span>FreeGame <b>Radar</b></span></Link><div className="nav-links"><a href="#deals">Раздачи</a><a href="#hot">Горящие</a><Link href="/admin">Система</Link></div><button className="sync" onClick={() => fetch("/api/sync", { method: "POST" }).then(load)}>Обновить источники</button></nav>
